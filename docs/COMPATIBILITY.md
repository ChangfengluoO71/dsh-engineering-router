...
11. verify the reviewer sees only `phase_begin` plus `read`, `glob`, and `grep`, cannot mutate/delegate, can read a generated review package, and returns a foreground verdict;
